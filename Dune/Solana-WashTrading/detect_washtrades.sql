...
select 
    lnt.*,
    COALESCE(sbs.same_buyer_seller,false) as same_buyer_seller,
    COALESCE(bft.back_forth_trade, false) as back_forth_trade,
    COALESCE(bs3.buy_same_3x,false) as buy_same_3x,
    COALESCE(ss3.sell_same_3x,false) as sell_same_3x,
    COALESCE(sbs.same_buyer_seller
            or bft.back_forth_trade
            or bs3.buy_same_3x
            or ss3.sell_same_3x, false) as is_wash_trade 
